...
#SBATCH --account=bcbw-delta-gpu               # <- one of: bbke-delta-cpu or bbke-delta-gpu

#SBATCH --job-name=MNIST_grpc_client2A40_FedCompass    # job name
#SBATCH --time=00:30:00                         # dd-hh:mm:ss for the job

#SBATCH -e MNIST_grpc_client2A40_FedCompass-err-%j.log
#SBATCH -o MNIST_grpc_client2A40_FedCompass-out-%j.log
