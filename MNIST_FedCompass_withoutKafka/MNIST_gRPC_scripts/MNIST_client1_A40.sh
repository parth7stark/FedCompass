...
#SBATCH --job-name=MNIST_grpc_client1A40_FedCompass    # job name
#SBATCH --time=00:30:00                         # dd-hh:mm:ss for the job

#SBATCH -e MNIST_grpc_client1A40_FedCompass-err-%j.log
#SBATCH -o MNIST_grpc_client1A40_FedCompass-out-%j.log
